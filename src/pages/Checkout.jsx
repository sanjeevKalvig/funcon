...
export default function Checkout() {
  const {
    /* optionally use displayPrice, etc */
  ...
  function proceedToMagentoCheckout() {
    ...
    const attachUrl = `https://rocking.magento.com/attach-cart?cartId=${encodeURIComponent(
      cartId
    )}`;
  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(80rem_80rem_at_65%_0%,rgba(59,130,246,.18),transparent),radial-gradient(40rem_40rem_at_10%_100%,rgba(251,146,60,.12),transparent)]">
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(80rem_80rem_at_65%_0%,rgba(59,130,246,.18),transparent),radial-gradient(40rem_40rem_at_10%_100%,rgba(251,146,60,.12),transparent)] to-black py-8 px-4 sm:px-6 lg:px-8">
                          ...
                          <div className="flex items-center gap-4 mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                value={it.qty}
                                onChange={(e) =>
                                  handleQtyChange(it.item_id, e.target.value)
                                }
